<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.Master" AutoEventWireup="true" CodeBehind="ListCategory.aspx.cs" Inherits="BTLWebForm.Admin.CategoryManagement.ListCategory" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <asp:Button ID="btnThem" Text="Thêm danh mục mới" runat="server" PostBackUrl="~/Admin/CategoryManagement/CreateCategory.aspx" CssClass="btn btn-success" />
